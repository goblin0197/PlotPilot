...
class Novel(BaseEntity):
    ...
    def __init__(
        ...
        - author: `str` 类型的业务输入，参与本函数的主要计算或流程控制。
        - target_chapters: `int` 类型的业务输入，参与本函数的主要计算或流程控制。
        - premise: `str` 类型的业务输入，参与本函数的主要计算或流程控制。
        - stage: `NovelStage` 类型的业务输入，参与本函数的主要计算或流程控制。
        - autopilot_status: `AutopilotStatus` 类型的业务输入，参与本函数的主要计算或流程控制。
        - auto_approve_mode: `bool` 类型的业务输入，参与本函数的主要计算或流程控制。
        - current_stage: `NovelStage` 类型的业务输入，参与本函数的主要计算或流程控制。
        - current_act: `int` 类型的业务输入，参与本函数的主要计算或流程控制。
        - current_chapter_in_act: `int` 类型的业务输入，参与本函数的主要计算或流程控制。
        - max_auto_chapters: `int` 类型的业务输入，参与本函数的主要计算或流程控制。
        - current_auto_chapters: `int` 类型的业务输入，参与本函数的主要计算或流程控制。
        - last_chapter_tension: `int` 类型的业务输入，参与本函数的主要计算或流程控制。
        - consecutive_error_count: 数量、范围或分页控制参数，用于限制处理规模。
        - current_beat_index: `int` 类型的业务输入，参与本函数的主要计算或流程控制。
        - last_audit_chapter_number: `Optional[int]` 类型的业务输入，参与本函数的主要计算或流程控制。
        - last_audit_similarity: `Optional[float]` 类型的业务输入，参与本函数的主要计算或流程控制。
        - last_audit_drift_alert: `bool` 类型的业务输入，参与本函数的主要计算或流程控制。
        - last_audit_narrative_ok: `bool` 类型的业务输入，参与本函数的主要计算或流程控制。
        - last_audit_at: `Optional[str]` 类型的业务输入，参与本函数的主要计算或流程控制。
        - last_audit_vector_stored: `bool` 类型的业务输入，参与本函数的主要计算或流程控制。
        - last_audit_foreshadow_stored: `bool` 类型的业务输入，参与本函数的主要计算或流程控制。
        - last_audit_triples_extracted: `bool` 类型的业务输入，参与本函数的主要计算或流程控制。
        - last_audit_quality_scores: `Optional[Dict[str, float]]` 类型的业务输入，参与本函数的主要计算或流程控制。
        - last_audit_issues: `Optional[List[Dict[str, str]]]` 类型的业务输入，参与本函数的主要计算或流程控制。
        - target_words_per_chapter: `int` 类型的业务输入，参与本函数的主要计算或流程控制。
        - audit_progress: `Optional[str]` 类型的业务输入，参与本函数的主要计算或流程控制。
